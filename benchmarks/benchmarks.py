...
class TimeSuite:
    ...
    def setup(self):
        self.data = DataFrame({
            "Term": ["1W", "2W", "3W", "1M", "2M", "3M", "4M", "5M", "6M", "7M", "8M", "9M", "10M", "11M", "12M", "18M",
                     "2Y", "3Y", "4Y"],
            "Rate": [5.30111, 5.30424, 5.30657, 5.31100, 5.34800, 5.38025, 5.40915, 5.43078, 5.44235, 5.44950, 5.44878,
                     5.44100, 5.42730, 5.40747, 5.3839, 5.09195, 4.85785, 4.51845, 4.31705],
        })
        self.data["Termination"] = [add_tenor(dt(2023, 8, 21), _, "F", "nyc") for _ in self.data["Term"]]
    ...
    def time_composite_curve_solver_and_values(self):
        ...
        Solver(
            ...
            instruments=[
                IRS(termination=_, **sofr_args) for _ in self.data["Termination"]
