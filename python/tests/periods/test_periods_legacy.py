...
@pytest.mark.skip(reason="Deprecated objects - replicated ")
...
class TestIndexFixedPeriodOnDeprecation:
    @pytest.mark.parametrize(
        ("method", "expected"),
        [("daily", 201.00502512562812), ("monthly", 200.98317675333183)],
    )
...
@pytest.mark.skip(reason="Deprecated objects. see replicated")
...
class TestIndexCashflowOnDeprecation:
    def test_cashflow_analytic_delta(self, curve) -> None:
...
@pytest.mark.skip(reason="Deprecated objects. See replciation")
...
class TestNonDeliverableCashflowOnDeprecation:
    @pytest.fixture(scope="class")
    def fxf_ndf(self):
        fxr = FXRates({"brlusd": 0.200}, settlement=dt(2025, 1, 23))
        fxf = FXForwards(
...
class TestNonDeliverableFixedPeriodOnDeprecation:
    @pytest.fixture(scope="class")
    def fxf_ndf(self):
        fxr = FXRates({"brlusd": 0.200}, settlement=dt(2025, 1, 23))
        fxf = FXForwards(
