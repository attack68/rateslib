...
from rateslib.instruments.components.fx_options.risk_reversal import FXOptionStrat
from rateslib.instruments.components.fx_options.straddle import FXStraddle
from rateslib.instruments.components.fx_options.strangle import FXStrangle
...
class FXBrokerFly(FXOptionStrat):
    """
    An *FX Strangle* :class:`~rateslib.instruments.components.FXOptionStrat`.

    A *Straddle* is composed of a lower strike :class:`~rateslib.instruments.components.FXPut`
    ...
    .. ipython:: python
       ...
       from rateslib.instruments.components import FXStraddle
    ...
    :class:`~rateslib.instruments.components.FXOptionStrat` where the number
