...
from rateslib.instruments.components.fx_options.call_put import FXCall, FXPut
...
class FXStraddle(FXOptionStrat):
    """
    An *FX Straddle* :class:`~rateslib.instruments.components.FXOptionStrat`.

    A *Straddle* is composed of a :class:`~rateslib.instruments.components.FXPut`
    and :class:`~rateslib.instruments.components.FXCall` with the same strike.
