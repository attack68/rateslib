...
class FXOption(_BaseInstrument, metaclass=ABCMeta):
    ...
    def leg1(self) -> CustomLeg:
        """The :class:`~rateslib.legs.components.CustomLeg` of the *Instrument* containing the
        :class:`~rateslib.periods.components.FXOptionPeriod`."""
        return self._leg1

    @property
    def leg2(self) -> CustomLeg:
        """The :class:`~rateslib.legs.components.CustomLeg` of the *Instrument* containing the
        premium :class:`~rateslib.periods.components.Cashflow`."""
        return self._leg2
