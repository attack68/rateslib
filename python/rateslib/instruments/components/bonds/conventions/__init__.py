...
from rateslib.instruments.components.bonds.conventions.accrued import ACC_FRAC_FUNCS
from rateslib.instruments.components.bonds.conventions.discounting import (
    C_FUNCS,
    V1_FUNCS,
    V2_FUNCS,
    V3_FUNCS,
...
if TYPE_CHECKING:
    from rateslib.instruments.components.bonds.conventions.accrued import AccrualFunction
    from rateslib.instruments.components.bonds.conventions.discounting import (
        CashflowFunction,
        YtmDiscountFunction,
