...
class _Scheduling:
    def next(self, ueffective: datetime) -> datetime: ...
    def previous(self, ueffective: datetime) -> datetime: ...
    def uregular(self, ueffective: datetime, utermination: datetime) -> datetime: ...
    def infer_front_stub(
        self, ueffective: datetime, utermination: datetime, short: bool
    ) -> datetime: ...
    def infer_back_stub(
        self, ueffective: datetime, utermination: datetime, short: bool
    ) -> datetime: ...
...
class Frequency(_Scheduling):
    ...
    @classmethod
    def BusDays(cls, number: int, calendar: CalTypes) -> Frequency: ...
    @classmethod
    def Weeks(cls, number: int) -> Frequency: ...
    @classmethod
    def Months(cls, number: int, rollday: RollDay) -> Frequency: ...
    @classmethod
...
class Adjuster(_Adjustment):
    @classmethod
    def Actual(cls) -> Adjuster: ...
    @classmethod
    def Following(cls) -> Adjuster: ...
    @classmethod
    def ModifiedFollowing(cls) -> Adjuster: ...
    @classmethod
    def FollowingSettle(cls) -> Adjuster: ...
    @classmethod
    def ModifiedFollowingSettle(cls) -> Adjuster: ...
    @classmethod
    def Previous(cls) -> Adjuster: ...
    @classmethod
    def ModifiedPrevious(cls) -> Adjuster: ...
    @classmethod
    def PreviousSettle(cls) -> Adjuster: ...
    @classmethod
    def ModifiedPreviousSettle(cls) -> Adjuster: ...
    @classmethod
    def BusDaysLagSettle(cls, number: int) -> Adjuster: ...
    @classmethod
    def CalDaysLagSettle(cls, number: int) -> Adjuster: ...
...
class _DateRoll:
    ...
    def roll(self, date: datetime, adjuster: Adjuster) -> datetime: ...
    def rolls(self, dates: list[datetime], adjuster: Adjuster) -> list[datetime]: ...
