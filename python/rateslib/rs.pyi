...
class Dual:
    ...
    dual: Arr1dF64 = ...
    @classmethod
    def vars_from(cls, other: Dual, real: float, vars: Sequence[str], dual: Sequence[float] | Arr1dF64) -> Dual: ...
...
class Dual2:
    def __init__(self, real: float, vars: Sequence[str], dual: Sequence[float] | Arr1dF64, dual2: Sequence[float]): ...
    real: float = ...
    vars: list[str] = ...
    dual: Arr1dF64 = ...
    dual2: Arr2dF64 = ...
    @classmethod
    def vars_from(cls, other: Dual2, real: float, vars: list[str], dual: list[float] | Arr1dF64, dual2: list[float] | Arr1dF64) -> Dual2: ...
