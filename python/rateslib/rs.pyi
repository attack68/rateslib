...
class PPSplineF64:
    ...
    def csolve(self, tau: list[float], y: list[float], left_n: int, right_n: int, allow_lsq: bool) -> None: ...
    ...
    def bsplev(self: list[float], i: int) -> list[float]: ...
    def bspldnev(self: list[float], i: int, m: int) -> list[float]: ...
    def bsplmatrix(self, tau: list[float], left_n: int, right_n: int) -> Arr2dF64: ...
    def __eq__(self, other: PPSplineF64) -> bool: ...
...
class PPSplineDual:
    ...
    def csolve(self, tau: list[float], y: list[Dual], left_n: int, right_n: int, allow_lsq: bool) -> None: ...
    ...
    def bsplev(self: list[float], i: int) -> list[Dual]: ...
    def bspldnev(self: list[float], i: int, m: int) -> list[Dual]: ...
    def bsplmatrix(self, tau: list[float], left_n: int, right_n: int) -> Arr2dF64: ...
    def __eq__(self, other: PPSplineDual) -> bool: ...
...
class PPSplineDual2:
    ...
    def csolve(self, tau: list[float], y: list[Dual2], left_n: int, right_n: int, allow_lsq: bool) -> None: ...
    ...
    def bsplev(self: list[float], i: int) -> list[Dual2]: ...
    def bspldnev(self: list[float], i: int, m: int) -> list[Dual2]: ...
    def bsplmatrix(self, tau: list[float], left_n: int, right_n: int) -> Arr2dF64: ...
    def __eq__(self, other: PPSplineDual2) -> bool: ...
    def __copy__(self) -> PPSplineDual2: ...
    def to_json(self) -> str: ...

def bsplev_single(x: float, i: int, k: int, t: list[float], org_k: int | None) -> float: ...
def bspldnev_single(x: float, i: int, k: int, t: list[float], m: int, org_k: int | None) -> float: ...
