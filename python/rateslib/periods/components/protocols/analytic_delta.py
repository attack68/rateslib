...
from rateslib.periods.components.parameters.settlement import _SettlementParams
    ...
    def analytic_delta(
        ...
        *base* accounting currency.
        ...
        .. hint::
           ...
           failure use
           :meth:`~rateslib.periods.components._WithAnalyticDelta.try_local_analytic_delta`.
