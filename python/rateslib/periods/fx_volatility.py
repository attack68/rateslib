...
class FXOptionPeriod(metaclass=ABCMeta):
    ...
    def npv(
        ...
        """
        if self.payment < disc_curve_ccy2.nodes.initial_node:
        ...
        if not isinstance(self.option_fixing, NoInput):
            ...
            value = _black76(
                ...
                K=self.strike,
                t_e=self._t_to_expiry(disc_curve_ccy2.nodes.initial_node),
    ...
    def _analytic_greeks(
        ...
        u = self.strike / f_d
        sqrt_t = self._t_to_expiry(disc_curve.nodes.initial_node) ** 0.5
