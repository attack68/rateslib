...
vernal_equinox_dict = {
    k+1970: datetime.strftime(v, "%Y-%m-%d") for k, v in enumerate(vernal_equinox_date)
}
...
autumn_equinox_dict = {
    k+1970: datetime.strftime(v, "%Y-%m-%d") for k, v in enumerate(autumn_equinox_date)
}
...
RULES = [
    ...
    Holiday("Vernal Equinox Day", month=3, day=20, observance=vernal_equinox),
    ...
    Holiday("Mountain Day", month=8, day=11, observance=sunday_to_monday, start_date=datetime(2016, 1, 1)),
    Holiday("Respect the Aged Day", month=9, day=1, offset=DateOffset(weekday=MO(3))),
    Holiday("Autumn Equinox Day", month=9, day=23, observance=autumn_equinox),
    ...
    Holiday("Emperor Akihito Birthday", month=12, day=23, observance=sunday_to_monday, end_date=datetime(2019, 12, 31)),
