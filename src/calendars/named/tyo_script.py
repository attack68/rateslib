...
RULES = [
    ...
    Holiday("Emperor Naruhito Birthday", month=2, day=23, observance=sunday_to_monday, start_date=datetime(2020, 1, 1)),
    ...
    Holiday("Marine Day: Pre olympics", month=7, day=1, offset=DateOffset(weekday=MO(3)), end_date=datetime(2019, 12, 31)),
    Holiday("Marine Day: Post olympics", month=7, day=1, offset=DateOffset(weekday=MO(3)), start_date=datetime(2022, 1, 1)),
    Holiday("Mountain Day: Pre olympics", month=8, day=11, observance=sunday_to_monday, start_date=datetime(2016, 1, 1), end_date=datetime(2019, 12, 31)),
    Holiday("Mountain Day: Post olympics", month=8, day=11, observance=sunday_to_monday, start_date=datetime(2022, 1, 1)),
    ...
    Holiday("Sports Day: Pre Olympics", month=10, day=1, offset=DateOffset(weekday=MO(2)), end_date=datetime(2019, 12, 31)),
    Holiday("Sports Day: Post olympics", month=10, day=1, offset=DateOffset(weekday=MO(2)), start_date=datetime(2022, 1, 1)),
    ...
    Holiday("Emperor Akihito Birthday", month=12, day=23, observance=sunday_to_monday, end_date=datetime(2019, 1, 1)),
