...
Some collected data at a point in time on Friday 4th Oct 2024
for the single security Pfizer US is below, with the intention of pricing and risking a 5Y Pfizer CDS.
...
This does not compare with an alternate system's `Rec Risk (1%)` of 78.75. To understand and
return this
