...
RULES = [
    ...
    Holiday("UK Early May Bank Holiday Pre 2020", month=5, day=1, offset=DateOffset(weekday=MO(1)), end_date=datetime(2020, 1, 1)),
    Holiday("UK Early May Bank Holiday Rearranged 2020", year=2020, month=5, day=8),
    Holiday("UK Early May Bank Holiday Post 2020 ", month=5, day=1, offset=DateOffset(weekday=MO(1)), start_date=datetime(2021, 1, 1)),
    Holiday(
